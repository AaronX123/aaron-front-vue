<template>
  <div class="dashboard-container">
    ...
    <el-form ref="combExamConfigItemDataList" :inline="true" :model="combExamConfigItemDataList" :rules="formRules">
      ...
      <el-main v-if="show">
        <el-table v-loading="listLoading" :data="combExamConfigItemDataList.combExamConfigItemVOs" border style="width: 100%" height="427px" @selection-change="handleSelectionChange">
    ...
    <div slot="footer" class="dialog-footer" style="algin: center">
      <el-button type="primary" :loading="addLoading" @click="updateSubmit('combExamConfigItemDataList')">保存配置项</el-button>
    ...
    <el-dialog title="基本信息" width="500px" :visible.sync="updateFormVisible" :close-on-click-modal="false">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" :loading="updateFormLoading" @click="updateItemFormSubmit('updateItemForm')">保存配置项</el-button>
...
<script>
  ...
  import { isOneToNinetyNine } from '@/utils/validate'
	export default {
		...
		data() {
			return {
				combExamConfig: this.$route.params.combExamConfig,
				// 试卷类型
				paperTypeOptions: [],
				// 修改窗口参数
				updateItemForm: {
